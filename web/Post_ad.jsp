<html>
    <head>
        ...
        <title>Afflx - Post Ad Page</title>
    ...
    <div class="container">
        <form>
            ...
            <div class="form-group">
                <label for="formControlRange">Total form fill</label>
...
<option value="Zimbabwe">Zimbabwe</option>
  ...
  <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
            ...
            <div class="col-sm-6 form-group">
                ...
                <select id="category" class="form-control browser-default custom-select">
                ...
                <option value="Book, Sports & Hobbies">Book, Sports & Hobbies</option>
            ...
            <div class="col-sm-6 form-group">
                ...
                <input type="text" class="form-control" name="year" id="year" placeholder="Enter Product Year..." required>
            </div>
            <div class="col-sm-6 form-group">
                <label for="year">AD title</label>
                <input type="text" class="form-control" name="Title" id="year" placeholder="Enter Ad TItle..." required>
            </div>
            <div class="col-sm-6 form-group">
                <label for="year">Description</label>
                <input type="text" class="form-control" name="Description" id="year" placeholder="Add Description..." required>
            </div>
            <div class="col-sm-6 form-group">
                <label for="price">Set Price</label>
                <input type="text" class="form-control" name="price" id="year" placeholder="Enter Price..." required>
            </div>
<!--            <div class="col-sm-6 form-group">
                <label for="photo">Upload Photo</label>
                <button type="button" class="btn btn-dark"><img src="assets/images/camera.jpg" alt="">               
                 </button>
            </div>-->
            <div class="col-sm-12">
